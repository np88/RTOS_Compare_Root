...
\documentclass[%
	12pt,		% 12pt font size
	headinclude,	% 
	%openany,	% Kapitel kÃ¶nnen auch auf der linken Seite anfangen.
	a4paper,	% Papierformat
	numbers=noenddot, % entgegen Duden Nr. 21, S. 21 R4 als CI festgelegt
	changebar,      % Ã„nderungsbalken mit \begin/\end{changebar}
...
\areaset[20mm]{160mm}{240mm}	% Binderand, Breite und HÃ¶he nutzbarer Bereich

\usepackage{bibgerm}		% FÃ¼r geralpha.bst. MUSS vor babel stehen
%\usepackage{pslatex}
...
\selectlanguage{ngerman}	% WÃ¤hle Standardsprache ...
...
\usepackage[T1]{fontenc}	% Verwende T1-Kodierung fÃ¼r ZeichensÃ¤tze        
...
%%% oder
%\ausgefuehrtam{%
%  am Institut fÃ¼r Werkzeugmaschinen und Betriebswissenschaften\\
...
% --------------------------------------------------------------------
	\pdfcompresslevel=9
        \RequirePackage[pdftex,		
		      %% fÃ¼r die DRUCK-Ausgabe bitte folgende
		      %% Einstellungen verwenden
		       pdfpagelabels=true,
                       bookmarks=true,
                       pagebackref=true,       % RÃ¼cklinks im Lit.-verz.
                       linktocpage=true,
                       plainpages=false,
		...
		%% fÃ¼r die .pdf-Datei-Ausgabe bitte diese
...
% Hier kÃ¶nnte eine Widmung stehen!
\begin{Widmung}
% oder auch nicht. ;)
\end{Widmung}
...
% bei elektronischer VerÃ¶ffentlichung.
% --------------------------------------------------------------------
%\pagestyle{empty}
\cleardoublepage 
\begin{abstract}
...
% --------------------------------------------------------------------
% Die Identifikation wesentlicher eigener Beiträge muss schon im
...
\bibliography{bib/literatur} % welche bib-Dateien
