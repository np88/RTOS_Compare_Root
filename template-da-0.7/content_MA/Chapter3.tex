...
The mean value is 727.71 ns and the standard deviation 4.775 ns. 
...
The mean value for 50000 measurements is 1.812 us with a standard deviation of 433.06 ns. 
This is only 2.5 times higher than in FreeRTOS. 
The maximum measured value is 3.51 us.
When put under stress by a constant SCP transfer, the value increases to a mean value of 2.679 us and a standard deviation of 1.30 us.
...
After stressing the system, the mean value stays almost constant at 10.486 us, but the standard deviation rises to 4.496 us and the maximum recorded value to 90 us.
...
A thread is waiting for an interrupt to occur and then issues a write command to turn off the \ac{LED}. 
...
The standard deviation is 3.897 us. 
...
The mean value for this experiment is 29.375 and the standard deviation is 6.202 us.
The maximum value here is about 100 us.

\paragraph{Mainline Linux}
...
\begin{figure}[htb]
	...
	\end{center}
	\caption{Interrupt latency standard Linux} \label{fig_interrupt_latency_linux}
\end{figure}
...
\begin{figure}[htb]
	...
	\end{center}
	\caption{Interrupt latency standard Linux with load} \label{fig_interrupt_latency_linux_load}
\end{figure}
