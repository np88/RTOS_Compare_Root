...
Still, it is worth trying whether an operation system like LinuxRT can meet the demands of a certain application.
The advantages are still overwhelming: Driver support for a wide range of hardware platforms, a large community, portability between different platforms and application maintenance independent of the \ac{OS}.  
