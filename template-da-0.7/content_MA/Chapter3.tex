...
\subsubsection{Mean Latency Estimation}\label{sss_mean_latency_estimation}
	...
	\centering
		\begin{tabular}{|l|l|l|l|}
			\hline
			  ...
			  \hline 
			  $t_{det}$			& 1.780 us  							& 15.465 us 				 		& 18.222 us	+ $t_{app}$		\\ 
			  \hline
			  \hline
...
\subsubsection{Pessimistic Latency Estimation}
	...
	\centering
		\begin{tabular}{|l|l|l|l|}
			\hline
			  ...
			  \hline 
			  $t_{det}$			& 2.013 us  							& 31.714 us 				 		& 41.163 us	+ $t_{app}$		\\ 
			  \hline
			  \hline
			  $t_{tick}$		& 4.312 us								& 28.892 us 					  & 28.892 us											\\
			  $t_{deam}$		& -				  							& - 				 						& ($t_{sync}$+$t_{app}$) * 0.2134	\\ 
