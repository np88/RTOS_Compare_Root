...
The starting point in this work is the Xilinx Linux version 3.6 with the corresponding RT patch.
...
All other drivers for \ac{USB} devices, blue ray or CD player and more were removed.
...
If this is not valid in special cases, it will be mentioned in the benchmark description.
...
\paragraph{Booting in Linux}
The booting process in Linux is shown in figure \ref{}.
