...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[scale=1]{inputs/pictures_ch1/linux_scheduling_classes}
	\end{center}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[scale=1]{inputs/pictures_ch1/linux_red_black_tree}
	\end{center}
...
Yet, there is still the possibility to remove unnecessary drivers and control the inputs of the system to avoid indeterministic jitter.
...
As cache analysis is a very complex topic and does not directly apply to the analysis of operation systems, it will not be covered by this work.
