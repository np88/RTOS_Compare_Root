...
Although light-weight \acp{OS} like FreeRTOS provide the best real-time performance, they include neither additional hardware drivers, the ability to flexibly load applications nor features for performance supervision. 
\par
...
The benchmark contains typical parameters which classify the behavior of \acp{RTOS}.
